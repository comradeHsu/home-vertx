...
public class HouseServiceVertxEBProxy implements HouseService {
  ...
  public HouseServiceVertxEBProxy(Vertx vertx, String address) {
    this(vertx, address, null);
  }

  public HouseServiceVertxEBProxy(Vertx vertx, String address, DeliveryOptions options) {
    this._vertx = vertx;
  ...
  public HouseService findAllHouseByType(int pageSize, int pageNumber, String type, Handler<AsyncResult<JsonArray>> resultHandler) {
    ...
    _json.put("pageNumber", pageNumber);
    _json.put("type", type);
    DeliveryOptions _deliveryOptions = (_options != null) ? new DeliveryOptions(_options) : new DeliveryOptions();
    _deliveryOptions.addHeader("action", "findAllHouseByType");
  ...
  public HouseService countByType(String type, Handler<AsyncResult<Long>> resultHandler) {
    ...
    _json.put("type", type);
    DeliveryOptions _deliveryOptions = (_options != null) ? new DeliveryOptions(_options) : new DeliveryOptions();
    _deliveryOptions.addHeader("action", "countByType");
  ...
  public HouseService findAllHouseByUserAndType(int pageSize, int pageNumber, String userId, String type, Handler<AsyncResult<JsonArray>> resultHandler) {
    ...
    _json.put("type", type);
    DeliveryOptions _deliveryOptions = (_options != null) ? new DeliveryOptions(_options) : new DeliveryOptions();
    _deliveryOptions.addHeader("action", "findAllHouseByUserAndType");
    _vertx.eventBus().<JsonArray>send(_address, _json, _deliveryOptions, res -> {
      if (res.failed()) {
        resultHandler.handle(Future.failedFuture(res.cause()));
      } else {
  ...
  public HouseService countByUserAndType(String userId, String type, Handler<AsyncResult<Long>> resultHandler) {
    ...
    _json.put("type", type);
    DeliveryOptions _deliveryOptions = (_options != null) ? new DeliveryOptions(_options) : new DeliveryOptions();
    _deliveryOptions.addHeader("action", "countByUserAndType");
    _vertx.eventBus().<Long>send(_address, _json, _deliveryOptions, res -> {
      if (res.failed()) {
        resultHandler.handle(Future.failedFuture(res.cause()));
      } else {
  ...
  public HouseService insertHouse(JsonObject house, Handler<AsyncResult<String>> resultHandler) {
    ...
    JsonObject _json = new JsonObject();
    _json.put("house", house);
    DeliveryOptions _deliveryOptions = (_options != null) ? new DeliveryOptions(_options) : new DeliveryOptions();
    _deliveryOptions.addHeader("action", "insertHouse");
