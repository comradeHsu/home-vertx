...
public class HouseServiceVertxProxyHandler extends ProxyHandler {
  ...
  public HouseServiceVertxProxyHandler(Vertx vertx, HouseService service) {
    this(vertx, service, DEFAULT_CONNECTION_TIMEOUT);
  }

  public HouseServiceVertxProxyHandler(Vertx vertx, HouseService service, long timeoutInSecond) {
    this(vertx, service, true, timeoutInSecond);
  }

  public HouseServiceVertxProxyHandler(Vertx vertx, HouseService service, boolean topLevel, long timeoutSeconds) {
    this.vertx = vertx;
  ...
  public void handle(Message<JsonObject> msg) {
    try {
      ...
      accessed();
      switch (action) {
        case "findAllHouseByType": {
          service.findAllHouseByType(json.getValue("pageSize") == null ? null : (json.getLong("pageSize").intValue()), json.getValue("pageNumber") == null ? null : (json.getLong("pageNumber").intValue()), (java.lang.String)json.getValue("type"), createHandler(msg));
          break;
        }
        case "countByType": {
